/*! MisEvent 3.0.1 | MIT*/var DEBUG=!1;
...
m=a._resetRunParam(),r,x,f,g,t=!1,s=!1;g=function(){t=!0};var q=function(){s=!0},u,v;a._runParam={};e.unshift(null);if(f=h.length)if(j){u=function(a){this.data=a._data;this.next=a.nextFunc;this.off=function(){a._disabled=!0}};u.prototype={param:m,removeParam:d,preventDefault:g,stopImmediatePropagation:q};for(g=function(a){DEBUG&&(a._hasRunned=!1);return function(){if(s)return!1;for(DEBUG&&a._hasRunned&&w("Func has runned before");a._disabled;)a=a.nextFuncData;e[0]=new u(a);DEBUG&&(a._hasRunned=!0);
return!1!==a._func.apply(c,e)}};f--;)thisFuncData=h[f],thisFuncData._disabled?h.splice(f,1):((nextFuncData=h[f+1])?(thisFuncData.nextFunc=g(nextFuncData),thisFuncData.nextFuncData=nextFuncData):(thisFuncData.nextFunc=y,nextFuncData=new B(y),nextFuncData.thisFunc=y),thisFuncData.nextFuncData=nextFuncData);if(g=h[0])e[0]=new u(g),DEBUG&&(g._hasRunned=!0),g._func.apply(this,e),DEBUG&&J(h)}else{u=function(a){this.preReturn=r;this.data=a._data;this.off=function(){a._disabled=!0}};u.prototype={param:m,
removeParam:d,preventDefault:g,stopImmediatePropagation:q};for(f=0;f<h.length;f++)if(g=h[f],g._disabled)h.splice(f,1),f--;else if(e[0]=new u(g),r=g._func.apply(this,e),s)break}if(!t&&!s&&(k&&(k[G]={preReturn:r,param:m,removeParam:d,stopImmediatePropagation:q},r=x=k.apply(this,arguments)),f=p.length,!s&&f))if(l){v=function(a){this.preReturn=r;this.data=a._data;this.next=a.nextFunc;this.off=function(){a._disabled=!0}};v.prototype={defaultReturn:x,param:m,removeParam:d,stopImmediatePropagation:stopImmediatePropagation};
for(q=function(a){DEBUG&&(a._hasRunned=!1);return function(){if(s)return!1;for(DEBUG&&a._hasRunned&&w("Func has runned before");a._disabled;)a=a.nextFuncData;e[0]=new v(a);DEBUG&&(a._hasRunned=!0);return!1!==a._func.apply(c,e)}};f--;)thisFuncData=p[f],thisFuncData._disabled?p.splice(f,1):((nextFuncData=p[f+1])?(nextFunc=q(nextFuncData),thisFuncData.nextFuncData=nextFuncData):(nextFunc=y,thisFuncData.nextFuncData=new B(nextFunc),thisFuncData.nextFuncData.thisFunc=nextFunc),thisFuncData.nextFunc=nextFunc);
if(g=p[0])e[0]=new v(g),DEBUG&&(g._hasRunned=!0),g._func.apply(this,e),DEBUG&&J(p)}else{v=function(a){this.preReturn=r;this.data=a._data;this.off=function(){a._disabled=!0}};v.prototype={defaultReturn:x,param:m,removeParam:d,stopImmediatePropagation:q};for(f=0;f<p.length;f++)if(g=p[f],g._disabled)p.splice(f,1),f--;else if(e[0]=new v(g),r=g._func.apply(this,e),s)break}if(n.length){q=function(a){this.preReturn=r;this.data=a._data;this.off=function(){a._disabled=!0}};q.prototype={defaultReturn:x,param:m,
removeParam:d};for(f=0;f<n.length;f++)if(g=n[f],g._disabled)n.splice(f,1),f--;else if(e[0]=new q(g),g._func.apply(this,e),s)break}return x}}},addFuncData:function(a,b){this[a].push(b)},getFuncData:function(a){return this[a]},mapFuncData:function(a,b){a?l(this[a],b):(l(this.before,b),l(this.after,b),l(this.end,b))},param:function(a,b){return E(a)?(this.setParam(a,b),this):this.getParam(a,b)},getParam:function(a,b){return b?this._baseParam[a]:this._runParam[a]},setParam:function(a,b){b&&D(this._baseParam,
a);D(this._runParam,a)},removeParam:function(a,b){b&&delete this._baseParam[a];delete this._runParam[a]}}),M=A(function(a){if(a[h])return a[h];this.func=a;a[h]=this},{hasObjData:function(a){return this[a]?!0:!1},getObjData:function(a){var b=this[a];b||(b={},this[a]=b);return b},hasFuncData:function(a,b){try{return this[a][b]?!0:!1}catch(c){return!1}},getFuncData:function(a,b){var c=this[a],d;c?(d=c[b])||(d=c[b]=[]):(c={},d=c[b]=[],this[a]=c);return d},mapFuncData:function(a,b,c){try{l(this[a][b],
c)}catch(d){}},addFuncData:function(a,b,c){this.getFuncData(a,b.fullEventName).push(c);this.getFuncData(a,"."+b.namespace).push(c)}});F.namespace=h;F.event=function(a){return z(a)?a[G]:a.callee[G]};return F}();
